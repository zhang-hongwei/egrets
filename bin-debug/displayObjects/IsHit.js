...
var IsHit = (function (_super) {
    __extends(IsHit, _super);
    function IsHit() {
    ...
    IsHit.prototype.onAddToStage = function () {
        this.loadResource();
        // setInterval(() => {
        //     console.log(1)
        // }, 1000);
    ...
    IsHit.prototype.loadResource = function () {
    ...
    IsHit.prototype.loadComplete = function () {
        ...
        this.img.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onMove, this);
        this.img.addEventListener(egret.TouchEvent.TOUCH_END, this.onMouseUp, this);
    };
    IsHit.prototype.onMove = function (evt) {
...
__reflect(IsHit.prototype, "IsHit");
