...
var DisplayObjects2 = (function (_super) {
    __extends(DisplayObjects2, _super);
    function DisplayObjects2() {
        var _this = _super.call(this) || this;
        _this.addEventListener(egret.Event.ADDED_TO_STAGE, _this.onAddToStage, _this);
        return _this;
    }
    DisplayObjects2.prototype.onAddToStage = function (event) {
    ...
    DisplayObjects2.prototype.loadR = function () {
    ...
    DisplayObjects2.prototype.onLoadComplete = function (event) {
        var reg = RES.getRes("cartoon");
        console.log("-______");
        console.log(reg);
    };
    DisplayObjects2.prototype.imgLoadHandler = function (evt) {
    ...
    return DisplayObjects2;
}(egret.DisplayObjectContainer));
__reflect(DisplayObjects2.prototype, "DisplayObjects2");
